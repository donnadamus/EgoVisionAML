# VSLBase implementation by magic team @ polito
...
class VSLBase(nn.Module):
    ...
    def forward(self, word_ids, char_ids, video_features, v_mask, q_mask):
        ...
        # features = self.cq_concat(features, query_features, q_mask) # concat cqa features with q tilde (feature encoder for query features, figure 4b)
        # h_score = self.highlight_layer(features, v_mask) # remove qgh passage
        # features = features * h_score.unsqueeze(2)
        start_logits, end_logits = self.predictor(features, mask=v_mask)

        # INFO REMOVED: removed h_score in return
    ...
    # Not used in VSLBase loss function
    """
